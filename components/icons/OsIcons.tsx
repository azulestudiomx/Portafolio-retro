...
export const IconNote: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 32 32" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="6" y="4" width="20" height="24" fill="#fff740" stroke="black" strokeWidth="2" />
    <path d="M6 24V28H22" stroke="black" strokeWidth="1" strokeOpacity="0.2" />
    <path d="M26 8V24" stroke="black" strokeWidth="1" strokeOpacity="0.2" />
    <line x1="10" y1="10" x2="22" y2="10" stroke="black" strokeWidth="1" strokeOpacity="0.5" />
    <line x1="10" y1="14" x2="22" y2="14" stroke="black" strokeWidth="1" strokeOpacity="0.5" />
    <line x1="10" y1="18" x2="22" y2="18" stroke="black" strokeWidth="1" strokeOpacity="0.5" />
    <circle cx="16" cy="6" r="1.5" fill="red" stroke="black" strokeWidth="0.5" />
  </svg>
);